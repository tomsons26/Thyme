...
class WinInstanceData
{
    enum
    {
        MAX_LAYOUT_FUNC_LEN = 256, // todo verify
        MAX_WINDOW_NAME_LEN = 64, // todo verify
        MAX_DRAW_DATA = 9,
        MAX_TEXT_LABEL = 128, // todo verify
...
public:
    ...
    unsigned int Get_State() { return m_state; }
    unsigned int Get_Style() { return m_style; }
    unsigned int Get_Status() { return m_status; }
